...
[assembly: InternalsVisibleTo("NINA.Plugin.CanonAstroImage.Tests")]
...
// Plugin identity. NINA uses this GUID as the plugin ID and as the key for every setting stored in user profiles.
// Never change it: existing users would lose their settings. If it ever has to change, ship a migration first.
